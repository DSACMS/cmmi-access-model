# ACCESS Eligibility Result Value Set - CMS ACCESS Model API v0.7.0
...
| | |
| :--- | :--- |
| *Official URL*:https://globalalliantinc.com/access/ValueSet/ACCESSEligibilityResultVS | *Version*:0.7.0 |
| Draft as of 2026-02-26 | *Computable Name*:ACCESSEligibilityResultVS |
...
```json
{
  ...
  "url" : "https://globalalliantinc.com/access/ValueSet/ACCESSEligibilityResultVS",
  "version" : "0.7.0",
