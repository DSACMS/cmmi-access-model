# Unalignment Request - CMS ACCESS Model API v0.9.1
...
| | |
| :--- | :--- |
| *Official URL*:https://dsacms.github.io/cmmi-access-model/OperationDefinition/Unalign | *Version*:0.9.1 |
| Active as of 2026-03-12 | *Computable Name*:Unalign |
...
```json
{
  ...
  "type" : true,
  "instance" : false,
  "inputProfile" : "https://dsacms.github.io/cmmi-access-model/StructureDefinition/access-unalign-in|0.9.1",
  "parameter" : [{
    "name" : "participantID",
    "use" : "in",
    "min" : 1,
