...
The ACCESS Model FHIR Implementation Guide (IG) references an Operations Manual that provides more information about the ACCESS Model APIs.
A link to the Operations Manuals will be made available soon.
...
### Project Vision
The project’s vision is of a healthcare system where Medicare beneficiaries with chronic conditions have equitable access to high-quality care, and where healthcare organizations are rewarded for achieving meaningful, sustained health outcomes.

### Project Mission
The project mission is to design, implement, and continuously improve the ACCESS Model's technical and operational infrastructure.  The project aims to support ACCESS Participants in delivering chronic care services to Medicare beneficiaries, while ensuring program integrity, data transparency, and a seamless experience for participants, beneficiaries, and CMS stakeholders.

### Agency Mission
The Centers for Medicare & Medicaid Services (CMS) is committed to achieving better care, smarter spending, and healthier people. CMS works to strengthen and modernize the nation's healthcare system by providing access to high-quality care and improved health at lower costs. The CMS Center for Medicare and Medicaid Innovation (CMMI) advances this mission by identifying, testing, and scaling innovative payment and service delivery models that improve quality, reduce costs, and expand access to care for Medicare and Medicaid beneficiaries.

### Team Mission
The ACCESS Model team is dedicated to building and sustaining a payment and care delivery framework that enables innovative approaches to chronic disease management in Medicare. Our team develops robust technical systems, clear policy guidance, and operational support helping ACCESS Participants to deliver high-quality, outcome-driven care to the patients who need it most.
