# ACCESS Unalignment API Capability Statement - CMS ACCESS Model API v0.9.1
...
| | |
| :--- | :--- |
| *Official URL*:https://dsacms.github.io/cmmi-access-model/CapabilityStatement/ACCESSUnalignmentAPICapabilityStatement | *Version*:0.9.1 |
...
```json
{
  ...
  "rest" : [{
    ...
    "resource" : [{
      ...
      "operation" : [{
        "name" : "unalign",
        "definition" : "https://dsacms.github.io/cmmi-access-model/OperationDefinition/Unalign|0.9.1",
