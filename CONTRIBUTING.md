...
5.  From your branch, make a pull request against `DSACMS/cmmi-access-model/main`
6.  Work with repo maintainers to get your change reviewed
7.  Wait for your change to be pulled into `DSACMS/cmmi-access-model/main`
...
cmmi-access-model will see regular updates and new releases. This section describes the general guidelines around how and when a new release is cut.
...
cmmi-access-model uses [Semantic Versioning](https://semver.org/). Each release is associated with a [`git tag`](github.com/DSACMS/cmmi-access-model/tags) of the form `X.Y.Z`.
...
The following steps outline the process to prepare a Release Candidate of cmmi-access-model. This process makes public the intention and contents of an upcoming release, while allowing work on the next release to continue as usual in `dev`.
...
The following steps describe how to make an approved [Release Candidate](#preparing-a-release-candidate) an official release of cmmi-access-model:
...
[proj-releases-new]: https://github.com/DSACMS/cmmi-access-model/releases/new
-->
...
docs. Please file an [issue](DSACMS/cmmi-access-model/issues).
-->
