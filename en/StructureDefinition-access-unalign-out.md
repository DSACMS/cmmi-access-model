# ACCESS Unalignment Response Parameters - CMS ACCESS Model API v0.9.6
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://dsacms.github.io/cmmi-access-model/ValueSet/ACCESSUnalignmentResultVS|0.9.6"
      }
    }]
  }
}
