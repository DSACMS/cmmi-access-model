# ACCESS Eligibility API Capability Statement - CMS ACCESS Model API v0.9.11
  ...
  "rest" : [{
    ...
    "resource" : [{
      ...
      "operation" : [{
        ...
        "definition" : "https://dsacms.github.io/cmmi-access-model/OperationDefinition/CheckEligibility|0.9.11",
