# ACCESS Data Reporting API Capability Statement - CMS ACCESS Model API v0.9.11
...
```json
{
  ...
  "rest" : [{
    ...
    "resource" : [{
      ...
      "operation" : [{
        "name" : "report-data",
        "definition" : "https://dsacms.github.io/cmmi-access-model/OperationDefinition/ReportData|0.9.11",
