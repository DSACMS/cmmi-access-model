# ACCESS Report Data Response Parameters - CMS ACCESS Model API v0.9.12
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://dsacms.github.io/cmmi-access-model/ValueSet/ACCESSReportDataResultVS|0.9.12"
      }
    }]
  }
}
