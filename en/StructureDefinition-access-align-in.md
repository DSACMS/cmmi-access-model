...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/cms.fhir.us.cmmi-access-model|current/StructureDefinition/StructureDefinition-access-align-in.json)
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "Parameters.parameter:isProviderReferral",
      "path" : "Parameters.parameter",
      "sliceName" : "isProviderReferral",
      "short" : "Provider referred?",
      "definition" : "Indicates whether the patient was referred to the ACCESS Model participant by a provider. This information helps track recruitment pathways and evaluate outreach effectiveness.",
      "min" : 1,
      "max" : "1",
      "mustSupport" : true
    },
    {
      "id" : "Parameters.parameter:isProviderReferral.modifierExtension",
      "path" : "Parameters.parameter.modifierExtension",
      "max" : "0"
    },
    {
      "id" : "Parameters.parameter:isProviderReferral.name",
      "path" : "Parameters.parameter.name",
      "fixedString" : "isProviderReferral",
      "mustSupport" : true
    },
    {
      "id" : "Parameters.parameter:isProviderReferral.value[x]",
      "path" : "Parameters.parameter.value[x]",
      "min" : 1,
      "type" : [{
        "code" : "boolean"
    ...
    {
      "id" : "Parameters.parameter:isProviderReferral.resource",
      "path" : "Parameters.parameter.resource",
      "max" : "0"
    },
    {
      ...
      "definition" : "Boolean flag indicating whether the patient has provided consent to switch from their current ACCESS participant to a new provider. This parameter is required when a patient wishes to align to a different provider after the initial 90-day lock-in period. [legal text goes here]",
      "min" : 0,
      "max" : "1",
      "mustSupport" : true
    },
