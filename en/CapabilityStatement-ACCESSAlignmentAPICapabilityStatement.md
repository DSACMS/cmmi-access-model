# ACCESS Alignment API Capability Statement - CMS ACCESS Model API v0.9.12
...
```json
{
  ...
  "rest" : [{
    ...
    "resource" : [{
      ...
      "operation" : [{
        "name" : "align",
        "definition" : "https://dsacms.github.io/cmmi-access-model/OperationDefinition/Align|0.9.12",
