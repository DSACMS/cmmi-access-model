# ACCESS Unalignment API Capability Statement - CMS ACCESS Model API v0.9.8
...
```json
{
  ...
  "rest" : [{
    ...
    "resource" : [{
      ...
      "operation" : [{
        "name" : "unalign",
        "definition" : "https://dsacms.github.io/cmmi-access-model/OperationDefinition/Unalign|0.9.8",
